...
def requested():
    ...
    phone=[]
    for i in a:
        url="https://www.fast2sms.com/dev/bulk?authorization=cwsW0i23R9o8d6xMXNGTtfb7OVBhvnPJDS4AuyqKe1kQHCLrlUimlcO4w9fAZQFh3xb8yKBqpkn70LWD&sender_id=FSTSMS&message=Need plasma of blood group&language=english&route=p&numbers="+str(i['phone'])
