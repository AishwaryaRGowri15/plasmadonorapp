...
def check(email):
    url = "https://q4li0oabhh.execute-api.us-west-2.amazonaws.com/plasma/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = "https://q4li0oabhh.execute-api.us-west-2.amazonaws.com/plasma/registration?"+params
...
@app.route('/stats')
def stats():
    url = "https://q4li0oabhh.execute-api.us-west-2.amazonaws.com/plasma/getbloodgroupsdata"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    #print(bloodgrp)
    url = "https://q4li0oabhh.execute-api.us-west-2.amazonaws.com/plasma/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
    for i in a:
        url="https://www.fast2sms.com/dev/bulk?authorization=cwsW0i23R9o8d6xMXNGTtfb7OVBhvnPJDS4AuyqKe1kQHCLrlUimlcO4w9fAZQFh3xb8yKBqpkn70LWD&sender_id=FSTSMS&message='Need plasma of your bloodgroup'&language=english&route=p&numbers="+str(i['phone'])
